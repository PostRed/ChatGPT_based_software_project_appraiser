...
from ast_metrics import attrs_, sattrs_, ctors_, methods_, smethods_, ncss_, impls_, \
...
class CodeMetrics:
    def __init__(self, trees, repozitory_name):
        self.min_nooa = 1000000
        self.max_nooa = 0
        self.total_nooa = 0
        self.nooa = 0

        self.min_nosa = 1000000
        self.max_nosa = 0
        self.total_nosa = 0
        self.nosa = 0
        self.min_nocc = 1000000
        self.max_nocc = 0
        self.total_nocc = 0
        self.nocc = 0
        self.min_noom = 1000000
        self.max_noom = 0
        self.total_noom = 0
        self.noom = 0
        self.min_nocm = 1000000
        self.max_nocm = 0
        self.total_nocm = 0
        self.nocm = 0
        self.min_ncss = 1000000
        self.max_ncss = 0
        self.total_ncss = 0
        self.ncss = 0
        self.min_noii = 1000000
        self.max_noii = 0
        self.total_noii = 0
        self.noii = 0
        self.min_napc = 1000000
        self.max_napc = 0
        self.total_napc = 0
        self.napc = 0
        self.min_notp = 1000000
        self.max_notp = 0
        self.total_notp = 0
        self.notp = 0
        self.min_final = 1000000
        self.max_final = 0
        self.total_final = 0
        self.final = 0
        self.min_noca = 1000000
        self.max_noca = 0
        self.total_noca = 0
        self.noca = 0
        self.min_varcomp = 1000000
        self.max_varcomp = 0
        self.total_varcomp = 0
        self.varcomp = 0
        self.min_mhf = 1000000
        self.max_mhf = 0
        self.total_mhf = 0
        self.mhf = 0
        self.min_smhf = 1000000
        self.max_smhf = 0
        self.total_smhf = 0
        self.smhf = 0
        self.min_ahf = 1000000
        self.max_ahf = 0
        self.total_ahf = 0
        self.ahf = 0
        self.min_sahf = 1000000
        self.max_sahf = 0
        self.total_sahf = 0
        self.sahf = 0
        self.min_nomp = 1000000
        self.max_nomp = 0
        self.total_nomp = 0
        self.nomp = 0
        self.min_nosmp = 1000000
        self.max_nosmp = 0
        self.total_nosmp = 0
        self.nosmp = 0
        self.min_mxnomp = 1000000
        self.max_mxnomp = 0
        self.total_mxnomp = 0
        self.mxnomp = 0
        self.min_mxnosmp = 1000000
        self.max_mxnosmp = 0
        self.total_mxnosmp = 0
        self.mxnosmp = 0
        self.min_nom = 1000000
        self.max_nom = 0
        self.total_nom = 0
        self.nom = 0
        self.min_nop = 1000000
        self.max_nop = 0
        self.total_nop = 0
        self.nop = 0
        self.min_nulls = 1000000
        self.max_nulls = 0
        self.total_nulls = 0
        self.nulls = 0
        self.min_doer = 1000000
        self.max_doer = 0
        self.total_doer = 0
        self.doer = 0
        self.trees = trees
    ...
    def save_metrics(self):
        with open(os.getcwd() + '/metrics_collection/files/code_metrics.csv', mode='a', newline='') as file:
